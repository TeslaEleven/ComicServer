...
const jd = require("./deploy-commands")
jd
...
client.on('interactionCreate', async interaction => {
  ...
  var csYear = interaction.options.getString('year')
  var csMonth = interaction.options.getString('month')
  var csDay = interaction.options.getString('day')
  var csDate = "wfv"
  var csImage = "wfv"
